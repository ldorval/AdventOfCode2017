...
namespace AdventOfCode
{
    ...
    public class Day4Part1Test
    {
        ...
        {
            var day4 = new Day4Part1(new List<string> { "aa bb cc dd ee", "aa bb cc dd aa", "aa bb cc dd aaa" });
            
            Assert.That(day4.ValidPassphraseCount(), Is.EqualTo(2));
        }

        [Test]
        public void SolutionPart1()
        {
            var day4 = new Day4Part1(input);
            
            Console.WriteLine(day4.ValidPassphraseCount());
        }
        
        [Test]
        public void SolutionPart2()
        {
            var day4 = new Day4Part2(input);
